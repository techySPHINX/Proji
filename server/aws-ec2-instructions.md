...
- **Clone your code repository from GitHub:**
  ...
  ```
  git clone https://github.com/techySPHINX/Proji
  ```
...
- **Create a pm2 ecosystem configuration file (inside server directory):**
  ...
  ```
  module.exports = { apps : [{ name: 'project-management', script: 'npm', args: 'run dev', env: { NODE_ENV: 'development', ENV_VAR1: 'environment-variable', } }], };
  ```
